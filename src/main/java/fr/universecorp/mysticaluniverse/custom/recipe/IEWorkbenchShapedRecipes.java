...
public class IEWorkbenchShapedRecipes implements Recipe<IEWorkbenchCraftingInventory> {
    ...
    public ItemStack craft(IEWorkbenchCraftingInventory craftingInventory) {
    ...
    public static class Type implements RecipeType<IEWorkbenchShapedRecipes> {
        private Type() { }
        public static final Type INSTANCE = new Type();
        public static final String ID = "ieworkbench_crafting";
    }

    public static class Serializer implements RecipeSerializer<IEWorkbenchShapedRecipes> {
        private Serializer() { }
        public static final Serializer INSTANCE = new Serializer();
        public static final String ID = "ieworkbench_crafting";

        public IEWorkbenchShapedRecipes read(Identifier identifier, JsonObject jsonObject) {
            String string = JsonHelper.getString(jsonObject, "group", "");
            Map<String, Ingredient> map = IEWorkbenchShapedRecipes.readSymbols(JsonHelper.getObject(jsonObject, "key"));
            String[] strings = IEWorkbenchShapedRecipes.removePadding(IEWorkbenchShapedRecipes.getPattern(JsonHelper.getArray(jsonObject, "pattern")));
            int i = strings[0].length();
            int j = strings.length;
            DefaultedList<Ingredient> defaultedList = IEWorkbenchShapedRecipes.createPatternMatrix(strings, map, i, j);
            ItemStack itemStack = IEWorkbenchShapedRecipes.outputFromJson(JsonHelper.getObject(jsonObject, "result"));
            return new IEWorkbenchShapedRecipes(identifier, string, i, j, defaultedList, itemStack);
        }

        public IEWorkbenchShapedRecipes read(Identifier identifier, PacketByteBuf packetByteBuf) {
        ...
        public void write(PacketByteBuf packetByteBuf, IEWorkbenchShapedRecipes shapedRecipe) {
